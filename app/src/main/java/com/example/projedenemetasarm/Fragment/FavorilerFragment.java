...
public class FavorilerFragment extends Fragment implements RexyclerViewInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View tasarim = inflater.inflate(R.layout.fragment_favoriler, container, false);
    ...
    private void eventChangeListener() {
        ...
        mFirestore.collection("deneme").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
